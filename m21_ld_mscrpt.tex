...
When viewing visual symbols presented in a sequence, as for example reading written text, statistical learning allows us to determine how likely it is that a particular symbol or letter will appear, given the letter that precedes or follows it. In this framework an orthographic unit, such as a word or affix, is defined by higher transitional probabilities between letters within a unit than between letters spanning two different units.   \citet{saffran_statistical_1996-1}, showed that  infants are sensitive to the statistical structure in a sequence of spoken nonsense syllables.  Later research showed that this type of learning is implicated in a wide variety of tasks and cognitive domains.
