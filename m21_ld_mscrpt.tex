...
Words are the primary means by which language conveys meaning, so learning to decode printed words is an important part of learning to read \citep[e.g.,][]{castles_ending_2018} .  All writing systems consist of abstract visual forms that are mapped onto a given unit of spoken language— the phoneme for alphabetic systems, the syllable for syllabaries, and the morpheme for logographies. An alphabetic system gains economy by mapping written units onto the small set of phonemes, rather than than the much larger set of morphemes in a language. Thus learning the relationship between letters and sounds is necessary and nonnegotiable for beginning readers of any alphabetic writing system.
