...
\begin{document}
	...
	\section{\citet*{zieglerReadingAcquisitionDevelopmental2005}}
	\begin{itemize}
	...
	\section{\citet*{andrewsLexicalPrecisionSkilled2010}}
	...
	\section{\citet*{andrewsMorphologicalPrimingStronger2013}}	
		...
		\begin{itemize}
			...
			\item \citet{taftStickyStickLocus2010} extended the IA framework by adding a layer of ‘lemma’ representations between the form and semantic levels
		...
		\begin{itemize}
			...
			\item  There are systematic individual differences amongst skilled university student readers in both semantic priming \citep{yapIndividualDifferencesJoint2009} and orthographic priming \citep{andrewsLexicalPrecisionSkilled2010, andrewsNotAllSkilled2012}
	...
	\section{\citet*{yapIndividualDifferencesJoint2009}}
	
		
		
	\section{\citet*{sanchez-gutierrezLetterTranspositionsMorphemic2013}}
	\begin{itemize}
		...
		\item \citet*{dunabeitiaTransposedletterSimilarityEffects2007} contrasted masked-priming effects on morphologically complex versus morphologically simple targets
	...
	\section{\citet*{dunabeitiaRevisitingLetterTranspositions2014}}
	\begin{itemize}
		\item \citet*{sanchez-gutierrezLetterTranspositionsMorphemic2013} found masked TL priming effects of similar magnitude for betweenand within-morpheme transpositions
