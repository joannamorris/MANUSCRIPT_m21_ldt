...
Syllabaries and alphabets gain economy by mapping written units onto the small set of syllables or even smaller set of  phonemes, rather than than the much larger set of morphemes in a language. Alphabets typically use a set of less than 100 symbols to fully express a language, whereas syllabaries can have several hundred, and logographies can have thousands of symbols.
